...
```
  ...
  <verify>
Build passes: `npm run build` completes without TypeScript errors.
Run simulation and verify Sell strategy calculates correctly without missing data warnings.
  </verify>
  <done>
Year-0 percentile data is correctly provided to calculateSellStrategy. Integration verified.
  </done>
</task>
