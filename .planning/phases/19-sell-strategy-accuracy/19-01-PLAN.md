...
must_haves:
  truths:
    - "Sell strategy terminal values are more realistic (lower than before fix)"
    - "BBD advantage over Sell is reduced (more accurate comparison)"
    - "User sees depletion probability that reflects actual withdrawal-first mechanics"
  artifacts:
