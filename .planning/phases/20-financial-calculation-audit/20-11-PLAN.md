...
must_haves:
  truths:
    - "User sees accurate tax calculations when changing cost basis"
    - "User sees accurate dividend tax calculations when changing yield"
    - "All 13 risk areas verified working in the UI"
  artifacts:
...
[ ] #13 Tax Rate Naming - Centralized in config module
  ...
  <done>All 13 risk areas verified, integration tests pass, manual UI checks complete</done>
</task>
