...
**4. Update the existing inline "What is Buy-Borrow-Die?" help-section:**
The existing help-section in the dashboard should remain but only be visible when the welcome screen is hidden. Add a CSS class to control this visibility:
- Add `class="bbd-inline-help"` to the existing help-section
  </action>
  <verify>
Template includes:
- `<button id="btn-guide"` in header
...
- guideBtn click handler opening user guide
...
- Inline BBD help section visible only when welcome is hidden
