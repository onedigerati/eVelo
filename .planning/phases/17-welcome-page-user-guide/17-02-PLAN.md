...
<task type="auto">
  <name>Task 1: Create user-guide-modal component</name>
...
3. Scrollable body with help-section accordions
4. Footer with disclaimer

**Help sections to include (each using `<help-section>` component):**
...
- template() returns overlay with modal, 8 help-sections, footer
...
- customElements.define('user-guide-modal', UserGuideModal) at bottom
  ...
  <done>
UserGuideModal component provides comprehensive, accessible documentation using progressive disclosure pattern.
  </done>
</task>

<task type="auto">
  <name>Task 2: Export user-guide-modal from barrel</name>
