...
In mobile DevTools at 375px width, verify in Elements > Computed panel:
- key-metrics-banner: Check .banner-container has overflow-x: hidden, max-width: 100%
- param-summary: Check .portfolio-section has overflow-x: hidden, max-width: 100%
- percentile-spectrum: Check .spectrum-container has max-width: 100%
- Verify none of these components have offsetWidth > parent offsetWidth
...
- Percentile spectrum bar fits within viewport
  ...
  <done>
All three components have max-width:100% constraints at mobile breakpoint; no horizontal clipping visible; DevTools Computed panel confirms max-width and overflow-x properties
  </done>
</task>
