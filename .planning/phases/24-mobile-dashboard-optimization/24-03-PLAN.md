...
must_haves:
  truths:
    - "Strategy analysis cards stack vertically on mobile without clipping"
    - "Salary equivalent banner fits viewport width on mobile"
    - "Recommendations section cards stack without overflow on mobile"
