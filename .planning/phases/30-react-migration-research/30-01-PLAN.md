...
<task type="auto">
  ...
  <action>
    ...
    4. **Document import dependencies:**
       - BaseComponent hierarchy (which components extend BaseComponent)
       - Component composition (which components import/use other components)
       - Import chain analysis (show dependency tree)
       - Shared dependencies (common imports like Chart.js, Dexie)
  ...
  <verify>
    ...
    - File contains import dependency section with BaseComponent hierarchy
    - File shows which components import/use other components
  </verify>
  <done>
    ...
    - Import dependency mapping (BaseComponent hierarchy, component composition)
    - Component relationship mapping (parent-child, event flow)
    - Summary statistics
  </done>
</task>
