...
<task type="auto">
  ...
  <action>
Manually calculate or verify contrast ratios for light theme combinations using WCAG relative luminance formula. Document results.
...
1. **--text-primary (#1e293b) on --surface-primary (#ffffff)**
   - Calculate: hex_to_luminance for both, apply contrast formula
